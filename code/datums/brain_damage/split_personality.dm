...
/mob/living/split_personality/try_speak(message, ignore_spam, forced, filterproof, mute_bypass) // OCULIS EDIT, ORIGINAL: /mob/living/split_personality/try_speak(message, ignore_spam, forced, filterproof)
